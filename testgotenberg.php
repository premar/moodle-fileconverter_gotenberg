...
/**
 * Test that Gotenberg is configured correctly.
 *
...
$PAGE->set_url(new moodle_url('/files/converter/gotenberg/testgotenberg.php'));
...
$converter = new \fileconverter_gotenberg\converter();
...
$result = \fileconverter_gotenberg\converter::test_connection();
